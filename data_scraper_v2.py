...
class PlayerScraper():
        ...
        def find_correct_page(self):
                ...
                open_tab = self.driver.find_elements(By.XPATH, '//button[@class="linked-list__dropdown-label js-dropdown-btn"]')[3]
                open_tab.click()
                time.sleep(3)

                rankings = self.driver.find_element(By.XPATH, '//a[contains(@href, "/rankings/mens/player-rankings")]')
                rankings.click()
        ...
        def current_batters(self):
                ...
                bat_full_table = self.driver.find_element(By.XPATH, '//a[contains(@href, "/rankings/mens/player-rankings/test/batting")]')
                bat_full_table.click()
        ...
        def current_bowlers(self):
                ...
                bowl_full_table = self.driver.find_element(By.XPATH, '//a[contains(@href, "/rankings/mens/player-rankings/test/bowling")]')
                bowl_full_table.click()
        ...
        def current_all_rounder(self):
                ...
                all_round_full_table = self.driver.find_element(By.XPATH, '//a[contains(@href, "/rankings/mens/player-rankings/test/all-rounder")]')
                all_round_full_table.click()
        ...
        def back_to_original_page(self):
                ...
                '''
                original_page = self.driver.find_elements(By.XPATH, '//li[@class="rankings-menu__item"]')[2]
                original_page.click()
                tests = self.driver.find_element(By.XPATH, '//a[@href="test"]')
                tests.click()
...
class DataScraper(PlayerScraper):
        ...
        def __init__(self, url = 'https://www.icc-cricket.com/homepage'):
                ...
                '''
                This function inherits from the PlayerScraper.
                This class scrapes data from the player profiles page
